    ...
    <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-red-500 to-red-600 flex-col justify-center items-center p-12 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-md">
        ...
        <h2 className="text-3xl font-bold text-white text-start mb-4">
          Streamline Your Mock Test Business
        </h2>
        <p className="text-white/80 mb-8 text-md text-start leading-relaxed">
          All-in-one platform to manage mock tests, question papers, and
          students. Simplify your test center operations and focus on what
          matters.
        </p>
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center text-white gap-3">
            ...
            <span className="text-sm">Manage Mock Tests & Schedules</span>
          </div>
          <div className="flex items-center text-white gap-3">
            <div className="bg-white/20 rounded-full p-2">
              <Check className="h-4 w-4 text-white" />
            </div>
            <span className="text-sm">Create & Organize Question Papers</span>
          </div>
          <div className="flex items-center text-white gap-3">
            <div className="bg-white/20 rounded-full p-2">
              <Check className="h-4 w-4 text-white" />
            </div>
            <span className="text-sm">Track Students & Results</span>
          </div>
        </div>
      </div>
    </div>
